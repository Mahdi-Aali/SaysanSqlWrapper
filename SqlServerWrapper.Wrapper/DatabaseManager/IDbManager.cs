...
public interface IDbManager
{
    ...
    public Task<TResponse> ExecuteScalerAsync<TResponse>(string cmd, CancellationToken cancellationToken = default);
    public Task<TResponse> ExecuteScalerWithParametersAsync<TResponse>(string cmd, object parameters, CancellationToken cancellationToken = default);
